...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $error = handleLogin($email, $password, 'admin');
}

// Custom header for admin login (no navbar usually, or simplified)
...
<head>
    ...
    <title>Admin Login - GreenBulk</title>
    <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;600;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link rel="stylesheet" href="<?php echo BASE_URL; ?>/assets/css/style.css">
    <style>
        body { background: var(--beige-accent); display: flex; align-items: center; justify-content: center; height: 100vh; margin: 0; }
    </style>
</head>
<body>
...
<div style="max-width: 400px; width: 90%; padding: 40px; border-radius: 15px; background: var(--white); box-shadow: var(--shadow);">
    <div style="text-align: center; margin-bottom: 30px;">
        ...
        <p style="color: var(--text-light);">Administrative Control Panel</p>
    </div>
    ...
    <form method="POST" action="">
        <div style="margin-bottom: 20px;">
            <label style="display: block; margin-bottom: 8px; font-size: 0.8rem; text-transform: uppercase; font-weight: 700; color: var(--text-light);">Admin Email</label>
        ...
        <button type="submit" class="btn btn-primary" style="width: 100%; padding: 14px;">Log In to Dashboard</button>
    </form>
